...
const me = {
  ...
  hasSiblings: true,
  shoeCount: 20,
  favThreeFoods: ['Tacos', 'Pasta', 'Gyros']
};
...
*/
console.log('I currently own', me.shoeCount, 'shoes');
me.shoeCount ++; 
console.log('I bought a new pair of shoes so now my shoe count is', me.shoeCount);
...
console.log('A litter about me:', me);